    ...
    <footer id="contact" className="footer">
      ...
      <div className="container">
        <div className="footer-top" data-reveal>
          ...
          <div className="social-row">
            <a
              ...
              href="#"
              aria-label="GitHub"
              data-toast="Opening GitHub — coming soon."
            >
            ...
            <a
              ...
              href="#"
              aria-label="LinkedIn"
              data-toast="Opening LinkedIn — coming soon."
            >
            ...
            <a
              ...
              data-toast="Opening X — coming soon."
            >
            ...
            <a
              ...
              href="#"
              aria-label="Dribbble"
              data-toast="Opening Dribbble — coming soon."
            >
        ...
        <div className="footer-bottom">
          <p>
            &copy; {new Date().getFullYear()} Adrian Vale — Designed &amp; built
            with intent.
          </p>
          <p className="mono footer-meta">
            JAKARTA · {jakartaTime || "--:--:--"} LOCAL
          </p>
          <a
            href="#home"
            className="back-top"
