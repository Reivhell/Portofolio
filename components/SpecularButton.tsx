...
const SpecularButton = ({
  ...
  useEffect(() => {
    ...
    // OGL (~227KB) dynamically imported — keeps the bundle out of the
    // critical path. The button renders with CSS immediately; the WebGL
    // specular effect loads and renders a frame or two later.
    let raf = 0;
    ...
    return () => {
      ...
      if (canvasRef && canvasRef.parentNode === fx) fx.removeChild(canvasRef);
